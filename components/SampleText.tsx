...
// Original sample text, now used as a default
const bakfung =
  "有jau5 一jat1 次ci3 ， \
...
const fusisaanhaa =
  ...
  為wai6  何ho4  為wai6  好hou2  事si6  淚leoi6  流lau4 ，\
  ...
  前cin4  塵can4  硬ngaang6  化faa3  像zoeng6  石sek6  頭tau4 ，\
...
interface SampleTextProps {
  sample?: string; // Make inputText optional
}

const SampleText: React.FC<SampleTextProps> = ({
  sample = "bakfung", // Use default if inputText is not provided
}) => {
        ...
        {parsedItems.map((item, index) => (
          ...
          >
            ...
            {item.jyutping ? (
              ...
              <span className="h-6 w-6 inline-block" /> // Placeholder for alignment
            )}
            {/* Character */}
