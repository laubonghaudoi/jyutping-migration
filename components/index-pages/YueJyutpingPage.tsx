    ...
    <>
        ...
        <table className="tg my-4 border border-collapse border-gray-300">
          <thead>
            <tr>
              ...
              <th className="tg-ed5u border p-2">雙脣音</th>
              <th className="tg-ed5u border p-2">脣齒音</th>
      ...
      <div className="overflow-x-auto">
        <table className="tg my-4 border border-collapse border-gray-300">
          <thead>
            <tr>
              <th className="tg-ed5u border p-2">爆發音</th>
              <th className="tg-8oy2 border p-2">
          ...
          <tbody>
            <tr>
              <td className="tg-ed5u border p-2">鼻音</td>
            ...
            <tr>
              <td className="tg-ed5u border p-2">元音</td>
              <td className="tg-8oy2 border p-2"> </td>
              <td className="tg-8oy2 border p-2">
      ...
      <div className="overflow-x-auto">
        {/* This table needs specific styling from the original CSS, which might not be fully replicated by Tailwind alone. */}
        {/* Consider adding a global CSS file or using styled-components if precise styling is needed. */}
      ...
      <div className="overflow-x-auto">
        <table className="tg my-4 border border-collapse border-gray-300">
          <thead>
            <tr>
              <th className="tg-ed5u border p-2"> </th>
