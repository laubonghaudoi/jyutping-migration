...
const NanJyutpingPage: React.FC = () => {
  return (
    <>
      <Chartaudio />
      ...
      <Alert title="關於 IPA 轉寫">
        <p>
          ...
          <a href="#參考文獻" className="text-blue-600 hover:underline">
            參考文獻
          </a>
          遐。
        </p>
      ...
      <h2 id="參考文獻" className="text-3xl font-semibold mt-8 mb-4">
        參考文獻
      </h2>
...
export default NanJyutpingPage;
